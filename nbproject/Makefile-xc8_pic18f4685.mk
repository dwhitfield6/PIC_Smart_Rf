...
FINAL_IMAGE=dist/${CND_CONF}/${IMAGE_TYPE}/PIC_Smart_Rf.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
SOURCEFILES_QUOTED_IF_SPACED=configuration_bits.c interrupts.c main.c system.c user.c MISC.c UART.c StringCommand.c RF.c ADC.c PWM.c LCD.c RTC.c I2C.c EEPROM.c IR.c Timer.c Button.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/configuration_bits.p1 ${OBJECTDIR}/interrupts.p1 ${OBJECTDIR}/main.p1 ${OBJECTDIR}/system.p1 ${OBJECTDIR}/user.p1 ${OBJECTDIR}/MISC.p1 ${OBJECTDIR}/UART.p1 ${OBJECTDIR}/StringCommand.p1 ${OBJECTDIR}/RF.p1 ${OBJECTDIR}/ADC.p1 ${OBJECTDIR}/PWM.p1 ${OBJECTDIR}/LCD.p1 ${OBJECTDIR}/RTC.p1 ${OBJECTDIR}/I2C.p1 ${OBJECTDIR}/EEPROM.p1 ${OBJECTDIR}/IR.p1 ${OBJECTDIR}/Timer.p1 ${OBJECTDIR}/Button.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/configuration_bits.p1.d ${OBJECTDIR}/interrupts.p1.d ${OBJECTDIR}/main.p1.d ${OBJECTDIR}/system.p1.d ${OBJECTDIR}/user.p1.d ${OBJECTDIR}/MISC.p1.d ${OBJECTDIR}/UART.p1.d ${OBJECTDIR}/StringCommand.p1.d ${OBJECTDIR}/RF.p1.d ${OBJECTDIR}/ADC.p1.d ${OBJECTDIR}/PWM.p1.d ${OBJECTDIR}/LCD.p1.d ${OBJECTDIR}/RTC.p1.d ${OBJECTDIR}/I2C.p1.d ${OBJECTDIR}/EEPROM.p1.d ${OBJECTDIR}/IR.p1.d ${OBJECTDIR}/Timer.p1.d ${OBJECTDIR}/Button.p1.d
...
# Source Files
SOURCEFILES=configuration_bits.c interrupts.c main.c system.c user.c MISC.c UART.c StringCommand.c RF.c ADC.c PWM.c LCD.c RTC.c I2C.c EEPROM.c IR.c Timer.c Button.c
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-xc8_pic18f4685.mk dist/${CND_CONF}/${IMAGE_TYPE}/PIC_Smart_Rf.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
dist/${CND_CONF}/${IMAGE_TYPE}/PIC_Smart_Rf.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE) --chip=$(MP_PROCESSOR_OPTION) -G -mdist/${CND_CONF}/${IMAGE_TYPE}/PIC_Smart_Rf.${IMAGE_TYPE}.map  -D__DEBUG=1 --debugger=pickit3  --double=24 --float=24 --emi=wordwrite --opt=default,+asm,+asmfile,+speed,-space,-debug --addrqual=ignore --mode=pro -P -N255 --warn=0 --asmlist --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,-download,+config,+clib,+plib --output=-mcof,+elf:multilocs --stack=compiled:auto:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"     --rom=default,-17d30-17fff --ram=default,-cf4-cff,-f9c-f9c,-fd4-fd4,-fdb-fdf,-fe3-fe7,-feb-fef,-ffd-fff  -odist/${CND_CONF}/${IMAGE_TYPE}/PIC_Smart_Rf.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
	@${RM} dist/${CND_CONF}/${IMAGE_TYPE}/PIC_Smart_Rf.${IMAGE_TYPE}.hex 
	
else
dist/${CND_CONF}/${IMAGE_TYPE}/PIC_Smart_Rf.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE) --chip=$(MP_PROCESSOR_OPTION) -G -mdist/${CND_CONF}/${IMAGE_TYPE}/PIC_Smart_Rf.${IMAGE_TYPE}.map  --double=24 --float=24 --emi=wordwrite --opt=default,+asm,+asmfile,+speed,-space,-debug --addrqual=ignore --mode=pro -P -N255 --warn=0 --asmlist --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,-download,+config,+clib,+plib --output=-mcof,+elf:multilocs --stack=compiled:auto:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"     -odist/${CND_CONF}/${IMAGE_TYPE}/PIC_Smart_Rf.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
